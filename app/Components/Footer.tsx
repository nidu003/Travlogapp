...
const Footer = () => {
  return (
    <footer className='relative max-container padding-container py-36 pt-10 flex xs:gap-12 lg:gap-20 xs:flex-col lg:flex-row'>
...
<div className='right lg:w-2/3 flex xs:flex-col md:flex-row xs:gap-10 md:gap-0 md:justify-between'>
  <div className='lg:flex lg:flex-row lg:gap-10 xs:hidden'>
    <FooterCard title="Company" link1="About" link2="Career" link3="Mobile" />
    <FooterCard title="Contact Us" link1="Why Travlog?" link2="Partner with us" link3="FAQ’s" link4="Blog" />
  ...
  <div className='lg:hidden xs:block w-full'>
    <select className='bg-gray-100 py-2 px-4 rounded-md w-full'>
      <option value="">Company</option>
      <option value="">About</option>
      <option value="">Career</option>
      <option value="">Mobile</option>
    </select>
    <select className='bg-gray-100 py-2 px-4 rounded-md mt-4 w-full'>
      <option value="">Contact Us</option>
      <option value="">Why Travlog?</option>
      <option value="">Partner with us</option>
      <option value="">FAQ’s</option>
      <option value="">Blog</option>
    </select>
    <select className='bg-gray-100 py-2 px-4 rounded-md mt-4 w-full'>
      <option value="">Meet Us</option>
      <option value="">+00 92 1234 56789</option>
      <option value="">info@travlog.com</option>
      <option value="">205. R Street, New York BD23200</option>
    </select>
  </div>
</div>
    </footer>
