  ...
  return (
    <section className='relative'>
      ...
      <div className='bg-[#fff9e8] xs:mx-8 lg:mx-24 xs:px-8 lg:padding-container xs:py-16 lg:py-28 flex flex-col xs:gap-12 lg:gap-20'>
        ...
        <div className='flexCenter xs:flex-col lg:flex-row xs:gap-4 lg:gap-8 w-full'>
          <input className='xs:py-4 lg:py-6 px-8 rounded-2xl w-full' type='text' placeholder='Your Email' />
          <button className='rounded-2xl bg-[#5D50C6] xs:text-sm lg:text-lg xs:px-4 lg:px-12 xs:py-4 lg:py-6 text-white xs:w-full lg:w-auto'>Subscribe</button>
        </div>   
      </div>
